// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InventoryOwnershipDetailsAfterCalculation.cs" company="Microsoft">
...
namespace Ecp.True.Bdd.Tests.Entities
{
    ...
    [FunctionOutput]
    public class InventoryOwnershipDetailsAfterCalculation
    {
        /// <summary>
        ...
        /// </value>
        [Parameter("string", "BlockchainInventoryProductId", 1)]
        public string BlockchainInventoryProductId { get; set; }

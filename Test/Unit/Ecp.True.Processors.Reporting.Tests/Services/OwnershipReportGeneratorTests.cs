// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OwnershipReportGeneratorTests.cs" company="Microsoft">
...
namespace Ecp.True.Processor.Reporting.Tests.Services
{
    ...
    /// <summary>
    /// The operational data without Ownership processor tests.
    /// </summary>
    [TestClass]
    public class OwnershipReportGeneratorTests : ReportGeneratorTests
    {
        /// <summary>
        /// The processor.
        /// </summary>
        private OperativeOwnershipReportGenerator processor;
        ...
        /// The mock logger.
        /// </summary>
        private Mock<ITrueLogger<OperativeOwnershipReportGenerator>> mockLogger;
        ...
        public void Initialize()
        {
            ...
            this.mockLogger = new Mock<ITrueLogger<OperativeOwnershipReportGenerator>>();
            ...
            this.processor = new OperativeOwnershipReportGenerator(this.mockUnitOfWorkFactory.Object, this.mockConfiguration.Object, this.mockLogger.Object);
        }
        ...
        {
            Assert.AreEqual(ReportType.OperativeBalance, this.processor.Type);
        }
    }
}

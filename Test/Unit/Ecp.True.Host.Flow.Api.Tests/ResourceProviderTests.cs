...
{
    using Ecp.True.Host.Flow.Api.Resources;
    ...
    public class ResourceProviderTests
    {
        ...
        public void Initialize()
        {
            ...
            this.mockLocalizerFactory.Setup(m => m.Create("SharedResource", "Ecp.True.Host.Flow.Api")).Returns(this.mockLocalizer.Object);

...
namespace Ecp.True.Host.Core.Tests.OpenApi
{
    ...
    public class AuthorizeOperationProcessorTests
    {
        ...
        {
            var context = this.BuildContext(typeof(CategoryController), "CreateCategoryAsync", "Category_CreateCategory");
            ...
            Assert.AreEqual("Administrator", context.OperationDescription.Operation.Security.FirstOrDefault().FirstOrDefault().Value.FirstOrDefault());
        }

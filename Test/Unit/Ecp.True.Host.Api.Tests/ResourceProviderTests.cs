...
{
    using Ecp.True.Host.Api.Resources;
    ...
    public class ResourceProviderTests
    {
        ...
        public void Initialize()
        {
            ...
            this.mockLocalizerFactory = this.mockRepository.Create<IStringLocalizerFactory>();
            ...
            this.mockLocalizerFactory.Setup(m => m.Create("SharedResource", "Ecp.True.Host.Api")).Returns(this.mockLocalizer.Object);

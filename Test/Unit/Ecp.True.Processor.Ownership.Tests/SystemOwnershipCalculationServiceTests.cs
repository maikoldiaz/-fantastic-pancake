// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SystemOwnershipCalculationServiceTests.cs" company="Microsoft">
...
namespace Ecp.True.Processor.Ownership.Tests
{
    ...
    /// </summary>
    [TestClass]
    public class SystemOwnershipCalculationServiceTests
    {
        /// <summary>
        ...
        /// </summary>
        private Mock<IRepository<SystemOwnershipCalculation>> mockOwnershipCalculationRepository;
        ...
        /// </summary>
        private SystemOwnershipCalculationService systemOwnershipCalculationService;
        ...
        /// The segment calculator mock.
        /// </summary>
        private Mock<IRepository<SystemDto>> mockSystemDtoRepository;
        ...
        public void IntilizeMethod()
        {
            ...
            this.mockSystemDtoRepository = new Mock<IRepository<SystemDto>>();

            this.mockOwnershipCalculationRepository = new Mock<IRepository<SystemOwnershipCalculation>>();

            this.mockOwnershipCalculationRepository.Setup(a => a.Insert(It.IsAny<SystemOwnershipCalculation>()));
            ...
            this.mockUnitOfWork.Setup(a => a.CreateRepository<SystemOwnershipCalculation>()).Returns(this.mockOwnershipCalculationRepository.Object);
            ...
            this.mockRepositoryFactory.Setup(s => s.CreateRepository<SystemDto>()).Returns(this.mockSystemDtoRepository.Object);
            this.mockUnitOfWork.Setup(a => a.SaveAsync(It.IsAny<CancellationToken>()));

            this.systemOwnershipCalculationService = new SystemOwnershipCalculationService(this.mockRepositoryFactory.Object, this.mockCalculateOwnership.Object);
        }
        ...
        [TestMethod]
        public async Task ProcessSystemOwnershipAsync_ShouldProcess_WithSuccessAsync()
        {
            ...
            this.mockSystemDtoRepository.Setup(s => s.ExecuteQueryAsync(It.IsAny<string>(), It.IsAny<Dictionary<string, object>>())).ReturnsAsync(systems);
            ...
            await this.systemOwnershipCalculationService.ProcessSystemOwnershipAsync(inventories, movements, 1).ConfigureAwait(false);

            this.mockCalculateOwnership.Verify(m => m.CalculateAndRegisterForSystem(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<DateTime>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<IEnumerable<Movement>>(), It.IsAny<IEnumerable<Movement>>(), It.IsAny<IEnumerable<InventoryProduct>>(), It.IsAny<IEnumerable<InventoryProduct>>(), It.IsAny<IEnumerable<Movement>>(), It.IsAny<IEnumerable<int>>()));
        }
    }
}

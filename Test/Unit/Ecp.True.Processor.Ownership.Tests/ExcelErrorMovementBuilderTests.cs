// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ExcelErrorMovementBuilderTests.cs" company="Microsoft">
...
namespace Ecp.True.Processor.Ownership.Tests
{
    ...
    /// <summary>
    /// The Excel Error Movement Tests.
    /// </summary>
    [TestClass]
    public class ExcelErrorMovementBuilderTests
    {
        /// <summary>
        ///  The builder.
        /// </summary>
        private ExcelErrorMovementBuilder builder;
        ...
        {
            this.builder = new ExcelErrorMovementBuilder();
        }

        /// <summary>
        /// Excels the error movement builder should build asynchronous.
        /// </summary>
        /// <returns>The task.</returns>
        [TestMethod]
        public async Task ExcelErrorMovementBuilder_ShouldBuildAsync()
        {
            using (DataSet ds = new DataSet())
            {
                using (DataTable dt = new DataTable("Movimientos"))
                {
                    ...
                    dt.Rows.Add(25116, 1029, 12727, "La regla 1 no existe", currentDate);
                    ...
                    Assert.AreEqual(1029, result[0]["MovementId"]);
                    Assert.AreEqual(12727, result[0]["SourceNodeId"]);
        ...
        /// <summary>
        /// Excels the error movement builder should return argument exception for incorrect datatype of fecha ejecucion asynchronous.
        /// </summary>
        /// <returns>The task.</returns>
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public async Task ExcelErrorMovementBuilder_ShouldReturnArgumentExceptionForIncorrectDatatypeOf_FechaEjecucion_Async()
        {
            using (DataSet ds = new DataSet())
            {
                using (DataTable dt = new DataTable("Movimientos"))

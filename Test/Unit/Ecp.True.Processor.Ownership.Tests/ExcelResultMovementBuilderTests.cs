// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ExcelResultMovementBuilderTests.cs" company="Microsoft">
...
namespace Ecp.True.Processor.Ownership.Tests
{
    ...
    /// </summary>
    [TestClass]
    public class ExcelResultMovementBuilderTests
    {
        /// <summary>
        ///  The builder.
        /// </summary>
        private ExcelMovementBuilder builder;
        ...
        {
            this.builder = new ExcelMovementBuilder();
        }

        /// <summary>
        /// Excels the result movement builder should build asynchronous.
        /// </summary>
        /// <returns>The task.</returns>
        [TestMethod]
        public async Task ExcelResultMovementBuilder_ShouldBuildAsync()
        {
            using (DataSet ds = new DataSet())
            {
                using (DataTable dt = new DataTable("Movimientos"))
                {
                    ...
                    dt.Rows.Add(23914, 153, 27, "Ecopetrol", 50D, 1000D, "Regla 1", "1", currentDate);
                    ...
                    Assert.AreEqual(153, result[0]["MovementId"]);
        ...
        /// <summary>
        /// Excels the result movement builder should return argument exception for incorrect datatype of porcentaje propiedad asynchronous.
        /// </summary>
        /// <returns>The task.</returns>
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public async Task ExcelResultMovementBuilder_ShouldReturnArgumentExceptionForIncorrectDatatypeOf_PorcentajePropiedad_Async()
        {
            using (DataSet ds = new DataSet())
            {
                using (DataTable dt = new DataTable("Movimientos"))
        ...
        /// <summary>
        /// Excels the result movement builder should return argument exception for incorrect datatype of volumen propiedad asynchronous.
        /// </summary>
        /// <returns>The task.</returns>
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public async Task ExcelResultMovementBuilder_ShouldReturnArgumentExceptionForIncorrectDatatypeOf_VolumenPropiedad_Async()
        {
            using (DataSet ds = new DataSet())
            {
                using (DataTable dt = new DataTable("Movimientos"))
        ...
        /// <summary>
        /// Excels the result movement builder should return argument exception for incorrect datatype of fecha ejecucion asynchronous.
        /// </summary>
        /// <returns>The task.</returns>
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public async Task ExcelResultMovementBuilder_ShouldReturnArgumentExceptionForIncorrectDatatypeOf_FechaEjecucion_Async()
        {
            using (DataSet ds = new DataSet())
            {
                using (DataTable dt = new DataTable("Movimientos"))

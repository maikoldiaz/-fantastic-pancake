// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SystemBalanceServiceTests.cs" company="Microsoft">
...
namespace Ecp.True.Processor.Balance.Tests
{
    ...
    [TestClass]
    public class SystemBalanceServiceTests
    {
        /// <summary>
        ...
        /// <summary>
        /// The mock system balance service.
        /// </summary>
        private SystemBalanceService systemBalanceService;

        /// <summary>
        /// The system calculator mock.
        /// </summary>
        private Mock<ISystemCalculator> systemCalculatorMock;
        ...
        public void Initialize()
        {
            ...
            this.systemCalculatorMock = new Mock<ISystemCalculator>();
            this.systemBalanceService = new SystemBalanceService(this.systemCalculatorMock.Object);
            ...
            this.unitOfWorkMock.Setup(s => s.CreateRepository<SystemDto>()).Returns(this.mockSystemDtoRepository.Object);
        ...
        [TestMethod]
        public async Task SystemBalanceServiceShouldCallSystemCalculatorAsync()
        {
            this.systemCalculatorMock.Setup(x => x.CalculateAndGetSystemUnbalance(It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<IEnumerable<Movement>>(), It.IsAny<IEnumerable<Movement>>(), It.IsAny<IEnumerable<InventoryProduct>>(), It.IsAny<IEnumerable<InventoryProduct>>(), It.IsAny<IEnumerable<Movement>>(), It.IsAny<IEnumerable<Movement>>(), It.IsAny<IUnitOfWork>())).Returns(new SystemUnbalance());
            ...
            await this.systemBalanceService.ProcessSystemAsync(1, this.unitOfWorkMock.Object).ConfigureAwait(false);
            this.systemCalculatorMock.Verify(x => x.CalculateAndGetSystemUnbalance(It.IsAny<string>(), It.IsAny<DateTime>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<IEnumerable<Movement>>(), It.IsAny<IEnumerable<Movement>>(), It.IsAny<IEnumerable<InventoryProduct>>(), It.IsAny<IEnumerable<InventoryProduct>>(), It.IsAny<IEnumerable<Movement>>(), It.IsAny<IEnumerable<Movement>>(), It.IsAny<IUnitOfWork>()));
        }
    }
}

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OwnershipRuleSynchronizerTests.cs" company="Microsoft">
...
namespace Ecp.True.Host.Functions.Tests
{
    ...
    [TestClass]
    public class OwnershipRuleSynchronizerTests
    {
        /// <summary>
        /// The ownership rule synchronizer.
        /// </summary>
        private OwnershipRuleSynchronizer ownershipRuleSynchronizer;

        /// <summary>
        /// The logger.
        /// </summary>
        private Mock<ITrueLogger<OwnershipRuleSynchronizer>> mockLogger;
        ...
        {
            this.mockLogger = new Mock<ITrueLogger<OwnershipRuleSynchronizer>>();
            ...
            this.ownershipRuleSynchronizer = new OwnershipRuleSynchronizer(
        ...
        /// <summary>
        /// Requests the owner ship asynchronous test asynchronous.
        /// </summary>
        /// <returns>Returns a completed task.</returns>
        [TestMethod]
        public async Task SyncOwnershipRulesAsync_ShouldSyncOwnershipRulesAsync()
        {
            this.SetupMocks(true);
            this.mockOwnershipRuleProcessor.Setup(a => a.SyncOwnershipRulesAsync(It.IsAny<string>())).Returns(Task.CompletedTask);

            await this.ownershipRuleSynchronizer.SyncOwnershipRulesAsync("System", null, null, new ExecutionContext() { InvocationId = Guid.NewGuid() }).ConfigureAwait(false);

            this.mockOwnershipRuleProcessor.Verify(a => a.SyncOwnershipRulesAsync("System"), Times.Once);
        }

        [TestMethod]
        public async Task SyncOwnershipRulesAsync_Should_Handle_ExceptionsAsync()
        {
            this.SetupMocks(true);
            this.mockOwnershipRuleProcessor.Setup(a => a.SyncOwnershipRulesAsync(It.IsAny<string>())).ThrowsAsync(new Exception());
        ...
        private void SetupMocks(bool isReady)
        {
            ...
            this.mockServiceProvider.Setup(s => s.GetService(typeof(ITrueLogger<OwnershipRuleSynchronizer>))).Returns(this.mockLogger.Object);

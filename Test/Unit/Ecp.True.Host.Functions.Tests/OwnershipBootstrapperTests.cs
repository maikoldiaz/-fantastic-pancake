// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OwnershipBootstrapperTests.cs" company="Microsoft">
...
{
    using Ecp.True.Host.Functions.Ownership.Bootstrap;
    ...
    /// </summary>
    [TestClass]
    public class OwnershipBootstrapperTests
    {
        /// <summary>

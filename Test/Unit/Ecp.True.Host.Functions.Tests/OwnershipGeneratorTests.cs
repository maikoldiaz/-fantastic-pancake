// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OwnershipGeneratorTests.cs" company="Microsoft">
...
namespace Ecp.True.Host.Functions.Tests
{
    ...
    /// </summary>
    [TestClass]
    public class OwnershipGeneratorTests
    {
        /// <summary>
        /// The ownership generator.
        /// </summary>
        private OwnershipGenerator ownershipGenerator;

        /// <summary>
        /// The logger.
        /// </summary>
        private Mock<ITrueLogger<OwnershipGenerator>> mockLogger;
        ...
        public void Initialize()
        {
            ...
            this.mockLogger = new Mock<ITrueLogger<OwnershipGenerator>>();
            ...
            this.ownershipGenerator = new OwnershipGenerator(
        ...
        [TestMethod]
        public async Task ReCalculateOwnershipAsync_ShouldProcessOwnershipRecalculationAsync()
        {
            this.SetupMocks(true);
            this.mockOwnershipRuleProcessor.Setup(a => a.GetOwnershipTicketByOwnershipNodeIdAsync(It.IsAny<int>())).ReturnsAsync(1);
            ...
            await this.ownershipGenerator.ReCalculateOwnershipAsync(new RecalculateOwnershipMessage(1, false), "label", "replyTo", new ExecutionContext()).ConfigureAwait(false);

            this.mockOwnershipRuleProcessor.Verify(a => a.GetOwnershipTicketByOwnershipNodeIdAsync(It.IsAny<int>()), Times.Once);
        ...
        /// <returns>The task.</returns>
        [TestMethod]
        public async Task ReCalculateOwnershipAsync_ShouldThrowExceptionAsync()
        {
            this.SetupMocks(true);
            this.mockOwnershipRuleProcessor.Setup(a => a.GetOwnershipTicketByOwnershipNodeIdAsync(It.IsAny<int>())).ThrowsAsync(new Exception());
            this.mockOwnershipRuleProcessor.Setup(a => a.ProcessAsync(It.IsAny<OwnershipRuleData>(), It.IsAny<ChainType>()));
            this.mockOwnershipRuleProcessor.Setup(a => a.FinalizeProcessAsync(It.IsAny<OwnershipRuleData>()));
            ...
            this.mockOwnershipRuleProcessor.Verify(a => a.GetOwnershipTicketByOwnershipNodeIdAsync(It.IsAny<int>()), Times.Once);
            this.mockOwnershipRuleProcessor.Verify(a => a.ProcessAsync(It.IsAny<OwnershipRuleData>(), It.IsAny<ChainType>()), Times.Never);
            this.mockOwnershipRuleProcessor.Verify(a => a.FinalizeProcessAsync(It.IsAny<OwnershipRuleData>()), Times.Never);
        }

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AvailabilityBootstrapperTests.cs" company="Microsoft">
...
{
    using Ecp.True.Host.Functions.Availability.Bootstrap;
    ...
    /// </summary>
    [TestClass]
    public class AvailabilityBootstrapperTests
    {
        /// <summary>

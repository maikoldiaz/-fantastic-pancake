// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ExcelRegistrationOrchestratorTests.cs" company="Microsoft">
...
namespace Ecp.True.Host.Functions.Tests
{
    ...
    [TestClass]
    public class ExcelRegistrationOrchestratorTests
    {
        /// <summary>
        ...
        /// The logger.
        /// </summary>
        private Mock<ITrueLogger<ExcelRegistrationOrchestrator>> mockLogger;
        ...
        /// </summary>
        private Mock<ITransformProcessor> mockExcelTransformProcessor;
        ...
        /// </summary>
        private ExcelRegistrationOrchestrator orchestrator;
        ...
        {
            this.mockLogger = new Mock<ITrueLogger<ExcelRegistrationOrchestrator>>();
            this.mockHomologator = new Mock<IHomologator>();
            this.mockExcelTransformProcessor = new Mock<ITransformProcessor>();
            this.mockExcelTransformProcessor.SetupGet(x => x.InputType).Returns(InputType.EXCEL);
            ...
            var transformProcessorsList = new List<ITransformProcessor>() { this.mockExcelTransformProcessor.Object };
            ...
            this.orchestrator = new ExcelRegistrationOrchestrator(
        ...
        public async Task DoRegisterAsync_ShouldRegister_WhenTriggeredAsync()
        {
            ...
            // Act
            await this.orchestrator.RegisterAsync(this.mockDurableOrchestrationContext.Object).ConfigureAwait(false);
        ...
        public async Task DoTransformAsync_ShouldTransform_WhenTriggeredAsync()
        {
            ...
            this.mockExcelTransformProcessor.Setup(x => x.TransformAsync(It.IsAny<TrueMessage>())).ReturnsAsync(registrationData);

            // Act
            var result = await this.orchestrator.TransformAsync(registrationData).ConfigureAwait(false);
        ...
        public async Task DoHomologateAsync_ShouldHomologate_WhenTriggeredAsync()
        {
            ...
            // Act
            var result = await this.orchestrator.HomologateAsync(registrationData).ConfigureAwait(false);
        ...
        public async Task DoCompleteAsync_ShouldComplete_WhenTriggeredAsync()
        {
            ...
            this.mockExcelTransformProcessor.Setup(x => x.CompleteAsync(It.IsAny<JArray>(), It.IsAny<TrueMessage>())).Returns(Task.CompletedTask);

            // Act
            await this.orchestrator.CompleteAsync(registrationData).ConfigureAwait(false);

            // Assert
            this.mockExcelTransformProcessor.Verify(x => x.CompleteAsync(It.IsAny<JArray>(), It.IsAny<TrueMessage>()), Times.Once);
        }

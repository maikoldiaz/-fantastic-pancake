// --------------------------------------------------------------------------------------------------------------------
// <copyright file="TransientRetryPolicyTests.cs" company="Microsoft">
...
namespace Ecp.True.ExceptionHandling.Tests
{
    ...
    /// <summary>
    /// The transient retry policy tests.
    /// </summary>
    [TestClass]
    public class TransientRetryPolicyTests
    {
        ...
        /// The retry policy.
        /// </summary>
        private TransientRetryPolicy retryPolicy;
        ...
        /// <summary>
        /// Transient retry policy execute with retry should retry when exception occurs.
        /// </summary>
        /// <returns>The task.</returns>
        [TestMethod]
        public async Task ExecuteWithRetryShouldRetryWhenFaultOccursAsync()
        {
        ...
        public void Setup()
        {
            ...
            this.retryPolicy = new TransientRetryPolicy(this.retrySettings, this.retryHandlerMock.Object);
        }

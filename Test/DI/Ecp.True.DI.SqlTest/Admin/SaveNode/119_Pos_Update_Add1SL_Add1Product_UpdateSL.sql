...
--			  Update Name of existing StorageLocation where id = 2
--			  Update description of existing StorageLocation where id = 3
--			  Add One more Product under existing StorageLocation where id = 3
--			  Disable two Products where id = 3, 4
...
Insert Into @NodeStorageLocationTableType  Values (0, 2, 'SLNode1 X', 'description1', 4, 1, 2, 1, '1000:C001', NULL , NULL, 'User1', @utcDate)
Insert Into @NodeStorageLocationTableType  Values (0, 3, 'SLNode2', 'New description1', 4, 1, 2, 1, '1000:M001', NULL , NULL, 'User1', @utcDate)

Delete from @StorageLocationProductTableType
INSERT INTO @StorageLocationProductTableType VALUES (1, 0, 1, '10000002372', 0, 'User1' , @utcDate, NULL, NULL)
INSERT INTO @StorageLocationProductTableType VALUES (0, 3, 0, '10000002093', 2, NULL , NULL, 'User1', @utcDate)
INSERT INTO @StorageLocationProductTableType VALUES (0, 4, 0, '10000002199', 3, NULL , NULL, 'User1', @utcDate)

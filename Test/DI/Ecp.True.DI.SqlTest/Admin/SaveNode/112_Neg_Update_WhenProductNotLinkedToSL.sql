...
-- UPDATE --> Try updating an existing Node when a Product is not linked to NodeStorageLocation.
...
Delete from @NodeStorageLocationTableType;
Insert Into @NodeStorageLocationTableType  Values (0, 2, 'SLNode1', 'description1', 4, 1, 2, 1, '1000:M001', NULL , NULL, 'User1', @utcDate)

Delete from @StorageLocationProductTableType
INSERT INTO @StorageLocationProductTableType VALUES (0, 3, 0, '10000002093', 1, NULL , NULL, 'User1', @utcDate)

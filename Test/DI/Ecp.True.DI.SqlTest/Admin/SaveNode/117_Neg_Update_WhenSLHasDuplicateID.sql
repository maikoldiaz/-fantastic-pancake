...
-- UPDATE --> Update When StorageLocation has duplicate NodeStorageLocationId in the incoming datatable.
--        Error: This should throw error - "Duplicate NodeStorageLocationId is found."
------------------------------------------------------------------------------------
...
Delete from @NodeStorageLocationTableType;
Insert Into @NodeStorageLocationTableType  Values (0, 2, 'SLNode1', 'description1', 4, 1, 2, 1, '1000:C001', 'System' , @utcDate, NULL, NULL)
Insert Into @NodeStorageLocationTableType  Values (0, 2, 'SLNode2', 'description1', 4, 1, 2, 1, '1000:M001', 'System' , @utcDate, NULL, NULL)

Delete from @StorageLocationProductTableType
INSERT INTO @StorageLocationProductTableType VALUES (0, 0, 1, '10000002049', 2, 'System' , @utcDate, NULL, NULL)

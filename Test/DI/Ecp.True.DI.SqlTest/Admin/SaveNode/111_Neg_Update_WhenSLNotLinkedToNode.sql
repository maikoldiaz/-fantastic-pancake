...
-- UPDATE --> Try updating an existing Node when a NodeStorageLocation is not linked to Node.
...
Delete from @NodeStorageLocationTableType;
Insert Into @NodeStorageLocationTableType  Values (0, 2, 'SLNode1', 'new description1', 4, 1, 1, 1, '1000:C001', NULL , NULL, 'User1', @utcDate)

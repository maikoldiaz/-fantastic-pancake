...
-- UPDATE --> Insert When StorageLocation has duplicate Name.
--        Error: This should throw error - "Duplicate StorageLocation Name found for the new node."
------------------------------------------------------------------------------------
...
Insert Into @NodeStorageLocationTableType  Values (1, 0, 'SLNode1', 'description1', 4, 1, 0, 1, '1000:M001', 'System' , @utcDate, NULL, NULL)
Insert Into @NodeStorageLocationTableType  Values (2, 0, 'SLNode1', 'description1', 4, 1, 0, 1, '1000:C001', 'System' , @utcDate, NULL, NULL)

...
-- UPDATE --> Update When StorageLocation has duplicate Name in DB but unique in incoming datatable.
--        Error: This should throw error - "Same StorageLocation Name already exists in database for the same node."
------------------------------------------------------------------------------------
...
Delete from @NodeStorageLocationTableType;
Insert Into @NodeStorageLocationTableType  Values (1, 0, 'SLNode2', 'description1', 4, 1, 2, 1, '1000:M001', 'System' , @utcDate, NULL, NULL)

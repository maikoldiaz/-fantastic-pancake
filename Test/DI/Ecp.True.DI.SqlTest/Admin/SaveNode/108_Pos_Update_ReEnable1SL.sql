...
-- UPDATE --> ReEnable NodeStorageLocation where Id = 2.
--			  Note: SP always expects that for an SL getting Activated at least one active product will come from API, no check in SP.
...
Delete from @NodeStorageLocationTableType;
Insert Into @NodeStorageLocationTableType  Values (0, 2, 'SLNode1', 'description1', 4, 0, 2, 1, '1000:C001', NULL , NULL, 'User2', @utcDate)
...
INSERT INTO @StorageLocationProductTableType VALUES (0, 3, 1, '10000002093', 2, NULL , NULL, 'User2', @utcDate)   -- Note: This Product can be optional, so it won't get activated if it doesn't come.

...
-- UPDATE --> Update When Products has duplicate StorageLocationProductId in the incoming datatable.
--        Error: This should throw error - "Duplicate StorageLocationProductId is found."
------------------------------------------------------------------------------------
...
Delete from @NodeStorageLocationTableType;
Insert Into @NodeStorageLocationTableType  Values (0, 2, 'SLNode1', 'new description1', 4, 1, 2, 1, '1000:M001', NULL, NULL, 'User1', @utcDate)

Delete from @StorageLocationProductTableType
INSERT INTO @StorageLocationProductTableType VALUES (0, 2, 1, '10000002049', 2, NULL, NULL, 'User1', @utcDate)
INSERT INTO @StorageLocationProductTableType VALUES (0, 2, 1, '10000002093', 2, NULL, NULL, 'User1', @utcDate)

-- 16. ******************************************************************************
-- Type = INSERT-UPDATE-Negative
-- UPDATE --> Update When StorageLocation has duplicate Name in the incoming datatable.
--        Error: This should throw error - "Duplicate StorageLocation Name found for the existing node."
------------------------------------------------------------------------------------
...
Delete from @NodeStorageLocationTableType;
Insert Into @NodeStorageLocationTableType  Values (0, 2, 'SLNode2', 'description1', 4, 1, 2, 1, '1000:M001', 'System' , @utcDate, NULL, NULL)
Insert Into @NodeStorageLocationTableType  Values (0, 3, 'SLNode2', 'description1', 4, 1, 2, 1, '1000:C001', 'System' , @utcDate, NULL, NULL)

Delete from @StorageLocationProductTableType
INSERT INTO @StorageLocationProductTableType VALUES (0, 0, 1, '10000002049', 3, 'System' , @utcDate, NULL, NULL)

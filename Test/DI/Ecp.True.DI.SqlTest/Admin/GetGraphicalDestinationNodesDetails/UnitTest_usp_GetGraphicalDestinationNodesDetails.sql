...
-- Description:     These test cases are for stored procedure [Admin].[usp_GetGraphicalDestinationNodesDetails]
...
EXEC [Admin].[usp_GetGraphicalDestinationNodesDetails] 6590
...
6592	Node_devtest03		NULL						7.99		Producción	FRONTERA	NULL		#08956C				NULL	1																																																																																																																																																																																																																																																																																																																																																									1
*/

-- Setting the IsDeleted to Inactive, therefore that NodeId will not be displayed for the Inactive Connection

UPDATE Admin.NodeConnection SET IsDeleted = 1 WHERE NodeConnectionId = 2658

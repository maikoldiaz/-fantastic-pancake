...
-- Description:     These test cases are for stored procedure [Admin].[usp_GetGraphicalSourceNodeConnectionsDetails]
...
EXEC [Admin].[usp_GetGraphicalSourceNodeConnectionsDetails] 6594
...
UPDATE Admin.NodeConnection SET IsDeleted = 1 WHERE NodeConnectionId = 2659

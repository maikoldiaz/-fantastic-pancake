...
-- Updated Date:
-- <Description>:   Unit test the procedure to delete movementtransaction. </Description>
-- ==============================================================================================================================*/

DECLARE @MovementTransactionIdList  [Admin].[KeyType]

INSERT INTO @MovementTransactionIdList 
(
	 [Key]	

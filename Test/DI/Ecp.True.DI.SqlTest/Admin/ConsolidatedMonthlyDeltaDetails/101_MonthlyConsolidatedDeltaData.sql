/*-- ============================================================================================================================
-- Author:          Microsoft
-- Created date: 	Jul-23-2020
-- Description:     This data can be used to test PBI-31881 report (Monthly Consolidate Delta Report)
-- ==============================================================================================================================*/

 --SELECT * FROM [Admin].[CategoryElement] WHERE [Name] = 'Automation_E003i'
 --SELECT * FROM [Admin].[Node] WHERE [Name] = 'Automation_N003i'


DECLARE @ElementName VARCHAR (50) = 'Automation_E003i'
       ,@NodeName VARCHAR (50)    = 'Automation_N003i'
	   ,@TicketId INT 
       ,@ElementId INT
       ,@NodeId INT
	   ,@OtherNodeId INT
	   ...
	   ,@InvProdId_7 INT
	   ,@InvProdId_8 INT
	   ,@FileRegistrationTransactionId INT = 310865						
...
INSERT INTO Offchain.MovementSource
(MovementTransactionId,	SourceNodeId,	SourceStorageLocationId,	SourceProductId,	SourceProductTypeId,	CreatedBy,	CreatedDate,	LastModifiedBy,	LastModifiedDate)
Values(@MTranId_8,			@NodeId,				NULL,					10000002372,		NULL,                   'Demo',		'2020-07-17',	NULL,			NULL)


INSERT INTO Offchain.MovementDestination
(MovementTransactionId,	DestinationNodeId,	DestinationStorageLocationId,	DestinationProductId,	DestinationProductTypeId,	CreatedBy,	CreatedDate,	LastModifiedBy,	LastModifiedDate)
VALUES(@MTranId_8,	@OtherNodeId,                       NULL,								10000002318,        NULL,						'Demo',		'2020-07-17',	NULL,			NULL	)
...
Values(	@NodeId,	10000002318,		19717,				10000002372,				156,		'2020-06-26','2020-06-30',	20000.00,			20000.00,				@MeasurementUnit,					@TicketId,		@ElementId,		1,				'2020-07-10',	1,			'System',	'2020-07-17',	NULL,			NULL)
...
INSERT INTO [Admin].ConsolidatedMovement
(SourceNodeId,	SourceProductId,	DestinationNodeId,	DestinationProductId,	MovementTypeId,	StartDate,		EndDate,	NetStandardVolume,	GrossStandardVolume,	MeasurementUnit,	TicketId,	SegmentId,	SourceSystemId,	ExecutionDate,	IsActive,	CreatedBy,	CreatedDate,	LastModifiedBy,	LastModifiedDate)
Values(	19717,	10000002318,		@NodeId,				10000002372,				156,		'2020-06-26','2020-06-30',	20000.00,			20000.00,				@MeasurementUnit,					@TicketId,		@ElementId,		1,				'2020-07-10',	1,			'System',	'2020-07-17',	NULL,			NULL)
...
INSERT INTO  [Admin].[ConsolidatedInventoryProduct](
NodeId,ProductId,InventoryDate,ProductVolume,GrossStandardQuantity,MeasurementUnit,TicketId,SegmentId,SourceSystemId,ExecutionDate,IsActive,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate) VALUES
	(@NodeId,	10000002318,	'2020-05-31 00:00:00.000',	100000.00,	120000.00,	@MeasurementUnit,	@TicketId,	@ElementId,	1,	'2020-07-11 00:00:00.000',	1	,'System'	,'2020-07-11 00:00:00.000',	NULL,	NULL)
...
INSERT INTO  [Admin].[ConsolidatedInventoryProduct](
NodeId,ProductId,InventoryDate,ProductVolume,GrossStandardQuantity,MeasurementUnit,TicketId,SegmentId,SourceSystemId,ExecutionDate,IsActive,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate) VALUES
	(@NodeId,	10000002372,	'2020-06-10 00:00:00.000',	100000.00,	120000.00,	@MeasurementUnit,	@TicketId,	@ElementId,	1,	'2020-07-11 00:00:00.000',	1	,'System'	,'2020-07-11 00:00:00.000',	NULL,	NULL)
SELECT @InvProdId_4 = SCOPE_IDENTITY()

INSERT INTO  [Admin].[ConsolidatedInventoryProduct](
NodeId,ProductId,InventoryDate,ProductVolume,GrossStandardQuantity,MeasurementUnit,TicketId,SegmentId,SourceSystemId,ExecutionDate,IsActive,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate) VALUES
	(@NodeId,	10000002372,	'2020-06-14 00:00:00.000',	100000.00,	120000.00,	@MeasurementUnit,	@TicketId,	@ElementId,	1,	'2020-07-11 00:00:00.000',	1	,'System'	,'2020-07-11 00:00:00.000',	NULL,	NULL)
SELECT @InvProdId_5 = SCOPE_IDENTITY()

INSERT INTO  [Admin].[ConsolidatedInventoryProduct](
NodeId,ProductId,InventoryDate,ProductVolume,GrossStandardQuantity,MeasurementUnit,TicketId,SegmentId,SourceSystemId,ExecutionDate,IsActive,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate) VALUES
	(@NodeId,	10000002372,	'2020-06-15 00:00:00.000',	100000.00,	120000.00,	@MeasurementUnit,	@TicketId,	@ElementId,	1,	'2020-07-11 00:00:00.000',	1	,'System'	,'2020-07-11 00:00:00.000',	NULL,	NULL)
...
INSERT INTO OFFCHAIN.Movement
(			MessageTypeId,	SystemTypeId,	SourceSystem,	EventType,	MovementId,	MovementTypeId,	TicketId,	SegmentId,	OperationalDate,	GrossStandardVolume,	NetStandardVolume,	UncertaintyPercentage,	MeasurementUnit,	ScenarioId,		Observations,					Classification,	IsDeleted,	IsSystemGenerated,	VariableTypeId,	FileRegistrationTransactionId,	OwnershipTicketId,	SystemName,	     ReasonId,	Comment,	MovementContractId,	BlockchainStatus,	BlockchainMovementTransactionId,	PreviousBlockchainMovementTransactionId,	Tolerance,	OperatorId,	BackupMovementId,	GlobalMovementId,	BalanceStatus,	SAPProcessStatus,	MovementEventId,	SourceMovementId,	TransactionHash,														BlockNumber,	RetryCount,	IsOfficial,	Version,	BatchId,	SystemId,	SourceSystemId,	IsTransferPoint,	SourceMovementTransactionId,	SourceInventoryProductId,	DeltaTicketId,	OfficialDeltaTicketId,	PendingApproval,	OfficialDeltaMessageTypeId,	ConsolidatedMovementTransactionId,	ConsolidatedInventoryProductId,	CreatedBy,	CreatedDate,	LastModifiedBy,	LastModifiedDate)
VALUES(         1,	          2,			'SINOPER',  	'Insert',    	1,		42,			@TicketId,			@ElementId, 	'2020-06-01',   	200.00,                 1500.00,				0.22,					@MeasurementUnit	,				2,		'Reporte Operativo Cusiana -Fecha'	,'Movimiento',	0,				NULL,				NULL,			@FileRegistrationTransactionId,							@TicketId,			'EXCEL - OCENSA',		NULL,	NULL,		  NULL,				1,	'6B20704E-75FA-4AB9-80F1-433EC58A4E51',					NULL,										NULL,		NULL,	NULL,					12345,			NULL,				NULL,			NULL,				NULL,				'0xb87b9522598e4ebffb34df496c3b9332904afcff0b33aa16106b8444283a0f24',	'0x15e650',			0,			0,		1,			NULL,			1,			1,				1,				NULL,							NULL,					NULL,			NULL,					NULL,				1,								NULL,									NULL,					'Demo',		'2020-07-17' ,	NULL,	NULL)
SELECT @MTranId_1 = SCOPE_IDENTITY()
...
INSERT INTO OFFCHAIN.Movement
(			MessageTypeId,	SystemTypeId,	SourceSystem,	EventType,	MovementId,	MovementTypeId,	TicketId,	SegmentId,	OperationalDate,	GrossStandardVolume,	NetStandardVolume,	UncertaintyPercentage,	MeasurementUnit,	ScenarioId,		Observations,					Classification,	IsDeleted,	IsSystemGenerated,	VariableTypeId,	FileRegistrationTransactionId,	OwnershipTicketId,	SystemName,	     ReasonId,	Comment,	MovementContractId,	BlockchainStatus,	BlockchainMovementTransactionId,	PreviousBlockchainMovementTransactionId,	Tolerance,	OperatorId,	BackupMovementId,	GlobalMovementId,	BalanceStatus,	SAPProcessStatus,	MovementEventId,	SourceMovementId,	TransactionHash,														BlockNumber,	RetryCount,	IsOfficial,	Version,	BatchId,	SystemId,	SourceSystemId,	IsTransferPoint,	SourceMovementTransactionId,	SourceInventoryProductId,	DeltaTicketId,	OfficialDeltaTicketId,	PendingApproval,	OfficialDeltaMessageTypeId,	ConsolidatedMovementTransactionId,	ConsolidatedInventoryProductId,	CreatedBy,	CreatedDate,	LastModifiedBy,	LastModifiedDate)
VALUES(         1,	          2,			'SINOPER',  	'Insert',    	1,		42,			@TicketId,			@ElementId, 	'2020-06-02',   	200.00,                 30.00,				0.22,					@MeasurementUnit	,				2,		'Reporte Operativo Cusiana -Fecha'	,'Movimiento',	0,				NULL,				NULL,			@FileRegistrationTransactionId,							@TicketId,			'EXCEL - OCENSA',		NULL,	NULL,		  NULL,				1,	'6B20704E-75FA-4AB9-80F1-433EC58A4E51',					NULL,										NULL,		NULL,	NULL,					12345,			NULL,				NULL,			NULL,				NULL,				'0xb87b9522598e4ebffb34df496c3b9332904afcff0b33aa16106b8444283a0f24',	'0x15e650',			0,			0,		1,			NULL,			1,			1,				1,				NULL,							NULL,					NULL,			NULL,					NULL,				3,								NULL,									NULL,					'Demo',		'2020-07-17' ,	NULL,	NULL)
SELECT @MTranId_3 = SCOPE_IDENTITY()
...
INSERT INTO Admin.ConsolidatedMovement
(SourceNodeId,	SourceProductId,	DestinationNodeId,	DestinationProductId,	MovementTypeId,	StartDate,		EndDate,	NetStandardVolume,	GrossStandardVolume,	MeasurementUnit,	TicketId,	SegmentId,	SourceSystemId,	ExecutionDate,	IsActive,	CreatedBy,	CreatedDate,	LastModifiedBy,	LastModifiedDate)
Values(	@NodeId,	10000002318,		19717,				10000002372,				156,		'2020-06-26','2020-06-30',	39048.00,			1600.00,				@MeasurementUnit,					@TicketId,		@ElementId,		1,				'2020-07-10',	1,			'System',	'2020-07-17',	NULL,			NULL)
SELECT @Con_Mov_1 = SCOPE_IDENTITY()

INSERT INTO Admin.ConsolidatedMovement
(SourceNodeId,	SourceProductId,	DestinationNodeId,	DestinationProductId,	MovementTypeId,	StartDate,		EndDate,	NetStandardVolume,	GrossStandardVolume,	MeasurementUnit,	TicketId,	SegmentId,	SourceSystemId,	ExecutionDate,	IsActive,	CreatedBy,	CreatedDate,	LastModifiedBy,	LastModifiedDate)
Values(	@NodeId,	10000002318,		19717,				10000002372,				156,		'2020-06-26','2020-06-30',	89283.00,			1200.00,				@MeasurementUnit,					@TicketId,		@ElementId,		1,				'2020-07-10',	1,			'System',	'2020-07-17',	NULL,			NULL)
SELECT @Con_Mov_2 = SCOPE_IDENTITY()

INSERT INTO Admin.ConsolidatedMovement
(SourceNodeId,	SourceProductId,	DestinationNodeId,	DestinationProductId,	MovementTypeId,	StartDate,		EndDate,	NetStandardVolume,	GrossStandardVolume,	MeasurementUnit,	TicketId,	SegmentId,	SourceSystemId,	ExecutionDate,	IsActive,	CreatedBy,	CreatedDate,	LastModifiedBy,	LastModifiedDate)
Values(	@NodeId,	10000002318,		19717,				10000002372,				156,		'2020-06-26','2020-06-30',	56293.00,			20000.00,				@MeasurementUnit,					@TicketId,		@ElementId,		1,				'2020-07-10',	1,			'System',	'2020-07-17',	NULL,			NULL)
SELECT @Con_Mov_3 = SCOPE_IDENTITY()

INSERT INTO Admin.ConsolidatedMovement
(SourceNodeId,	SourceProductId,	DestinationNodeId,	DestinationProductId,	MovementTypeId,	StartDate,		EndDate,	NetStandardVolume,	GrossStandardVolume,	MeasurementUnit,	TicketId,	SegmentId,	SourceSystemId,	ExecutionDate,	IsActive,	CreatedBy,	CreatedDate,	LastModifiedBy,	LastModifiedDate)
Values(	@NodeId,	10000002318,		19717,				10000002372,				156,		'2020-06-26','2020-06-30',	76800.00,			34500.00,				@MeasurementUnit,					@TicketId,		@ElementId,		1,				'2020-07-10',	1,			'System',	'2020-07-17',	NULL,			NULL)
SELECT @Con_Mov_4 = SCOPE_IDENTITY()
...
INSERT INTO  [Admin].[ConsolidatedInventoryProduct](
NodeId,ProductId,InventoryDate,ProductVolume,GrossStandardQuantity,MeasurementUnit,TicketId,SegmentId,SourceSystemId,ExecutionDate,IsActive,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate) VALUES
	(@NodeId,	10000002318,	'2020-06-30 00:00:00.000',	104500.00,	78.00,	@MeasurementUnit,	@TicketId,	@ElementId,	1,	'2020-07-11 00:00:00.000',	1	,'System'	,'2020-07-11 00:00:00.000',	NULL,	NULL)
SELECT @InvProdId_1 = SCOPE_IDENTITY()

INSERT INTO  [Admin].[ConsolidatedInventoryProduct](
NodeId,ProductId,InventoryDate,ProductVolume,GrossStandardQuantity,MeasurementUnit,TicketId,SegmentId,SourceSystemId,ExecutionDate,IsActive,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate) VALUES
	(@NodeId,	10000002318,	'2020-05-31 00:00:00.000',	97984.00,	45.00,	@MeasurementUnit,	@TicketId,	@ElementId,	1,	'2020-07-11 00:00:00.000',	1	,'System'	,'2020-07-11 00:00:00.000',	NULL,	NULL)
SELECT @InvProdId_2 = SCOPE_IDENTITY()

INSERT INTO  [Admin].[ConsolidatedInventoryProduct](
NodeId,ProductId,InventoryDate,ProductVolume,GrossStandardQuantity,MeasurementUnit,TicketId,SegmentId,SourceSystemId,ExecutionDate,IsActive,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate) VALUES
	(@NodeId,	10000002318,	'2020-06-13 00:00:00.000',	235346.00,	2.00,	@MeasurementUnit,	@TicketId,	@ElementId,	1,	'2020-07-11 00:00:00.000',	1	,'System'	,'2020-07-11 00:00:00.000',	NULL,	NULL)
SELECT @InvProdId_3 = SCOPE_IDENTITY()

INSERT INTO  [Admin].[ConsolidatedInventoryProduct](
NodeId,ProductId,InventoryDate,ProductVolume,GrossStandardQuantity,MeasurementUnit,TicketId,SegmentId,SourceSystemId,ExecutionDate,IsActive,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate) VALUES
	(@NodeId,	10000002372,	'2020-06-13 00:00:00.000',	344.00,	567.00,	@MeasurementUnit,	@TicketId,	@ElementId,	1,	'2020-07-11 00:00:00.000',	1	,'System'	,'2020-07-11 00:00:00.000',	NULL,	NULL)
SELECT @InvProdId_4 = SCOPE_IDENTITY()

INSERT INTO  [Admin].[ConsolidatedInventoryProduct](
NodeId,ProductId,InventoryDate,ProductVolume,GrossStandardQuantity,MeasurementUnit,TicketId,SegmentId,SourceSystemId,ExecutionDate,IsActive,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate) VALUES
	(@NodeId,	10000002372,	'2020-06-14 00:00:00.000',	3453.00,	34.00,	@MeasurementUnit,	@TicketId,	@ElementId,	1,	'2020-07-11 00:00:00.000',	1	,'System'	,'2020-07-11 00:00:00.000',	NULL,	NULL)
SELECT @InvProdId_5 = SCOPE_IDENTITY()

INSERT INTO  [Admin].[ConsolidatedInventoryProduct](
NodeId,ProductId,InventoryDate,ProductVolume,GrossStandardQuantity,MeasurementUnit,TicketId,SegmentId,SourceSystemId,ExecutionDate,IsActive,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate) VALUES
	(@NodeId,	10000002372,	'2020-06-15 00:00:00.000',	23545.00,	6754.00,	@MeasurementUnit,	@TicketId,	@ElementId,	1,	'2020-07-11 00:00:00.000',	1	,'System'	,'2020-07-11 00:00:00.000',	NULL,	NULL)
SELECT @InvProdId_6 = SCOPE_IDENTITY()

INSERT INTO  [Admin].[ConsolidatedInventoryProduct](
NodeId,ProductId,InventoryDate,ProductVolume,GrossStandardQuantity,MeasurementUnit,TicketId,SegmentId,SourceSystemId,ExecutionDate,IsActive,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate) VALUES
	(@NodeId,	10000002318,	'2020-06-30 00:00:00.000',	23.00,	765.00,	@MeasurementUnit,	@TicketId,	@ElementId,	1,	'2020-07-11 00:00:00.000',	1	,'System'	,'2020-07-11 00:00:00.000',	NULL,	NULL)
SELECT @InvProdId_7 = SCOPE_IDENTITY()

INSERT INTO  [Admin].[ConsolidatedInventoryProduct](
NodeId,ProductId,InventoryDate,ProductVolume,GrossStandardQuantity,MeasurementUnit,TicketId,SegmentId,SourceSystemId,ExecutionDate,IsActive,CreatedBy,CreatedDate,LastModifiedBy,LastModifiedDate) VALUES
	(@NodeId,	10000002318,	'2020-05-31 00:00:00.000',	47447.00,	2353.00,	@MeasurementUnit,	@TicketId,	@ElementId,	1,	'2020-07-11 00:00:00.000',	1	,'System'	,'2020-07-11 00:00:00.000',	NULL,	NULL)
SELECT @InvProdId_8 = SCOPE_IDENTITY()

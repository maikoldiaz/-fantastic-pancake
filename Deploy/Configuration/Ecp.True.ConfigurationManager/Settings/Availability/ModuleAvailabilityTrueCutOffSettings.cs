// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModuleAvailabilityTrueCutOffSettings.cs" company="Microsoft">
...
namespace Ecp.True.ConfigurationManager.Settings
{
    ...
    /// </summary>
    public class ModuleAvailabilityTrueCutOffSettings : SettingsBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModuleAvailabilityTrueCutOffSettings"/> class.
        /// </summary>
        public ModuleAvailabilityTrueCutOffSettings()
        {
            this.Name = "TrueCutOff";
        ...
        /// </value>
        [JsonIgnore]
        public override string Key => "ModuleAvailabilityTrueCutOff.Settings";

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModuleAvailabilityTrueLoadFilesTransportSettings.cs" company="Microsoft">
...
namespace Ecp.True.ConfigurationManager.Settings
{
    ...
    /// <summary>
    /// ModuleAvailabilityTrueLoadFiles_TransportSettings.
    /// </summary>
    public class ModuleAvailabilityTrueLoadFilesTransportSettings : SettingsBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModuleAvailabilityTrueLoadFilesTransportSettings"/> class.
        /// </summary>
        public ModuleAvailabilityTrueLoadFilesTransportSettings()
        {
            this.Name = "TrueLoadFiles_Transport";
        ...
        /// </value>
        [JsonIgnore]
        public override string Key => "ModuleAvailabilityTrueLoadFilesTransport.Settings";

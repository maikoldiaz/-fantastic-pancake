// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModuleAvailabilityTrueOwnershipAdjSettings.cs" company="Microsoft">
...
namespace Ecp.True.ConfigurationManager.Settings
{
    ...
    /// </summary>
    public class ModuleAvailabilityTrueOwnershipAdjSettings : SettingsBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModuleAvailabilityTrueOwnershipAdjSettings"/> class.
        /// </summary>
        public ModuleAvailabilityTrueOwnershipAdjSettings()
        {
            this.Name = "TrueOwnershipAdj";
        ...
        /// </value>
        [JsonIgnore]
        public override string Key => "ModuleAvailabilityTrueOwnershipAdj.Settings";

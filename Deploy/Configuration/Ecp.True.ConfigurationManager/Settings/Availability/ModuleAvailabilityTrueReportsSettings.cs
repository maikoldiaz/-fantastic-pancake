// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModuleAvailabilityTrueReportsSettings.cs" company="Microsoft">
...
namespace Ecp.True.ConfigurationManager.Settings
{
    ...
    /// </summary>
    public class ModuleAvailabilityTrueReportsSettings : SettingsBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModuleAvailabilityTrueReportsSettings"/> class.
        /// </summary>
        public ModuleAvailabilityTrueReportsSettings()
        {
            this.Name = "TrueReports";
        ...
        /// </value>
        [JsonIgnore]
        public override string Key => "ModuleAvailabilityTrueReports.Settings";

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModuleAvailabilityTrueLoadFilesChainSettings.cs" company="Microsoft">
...
namespace Ecp.True.ConfigurationManager.Settings
{
    ...
    /// </summary>
    public class ModuleAvailabilityTrueLoadFilesChainSettings : SettingsBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModuleAvailabilityTrueLoadFilesChainSettings"/> class.
        /// </summary>
        public ModuleAvailabilityTrueLoadFilesChainSettings()
        {
            this.Name = "TrueLoadFiles_Chain";
        ...
        /// </value>
        [JsonIgnore]
        public override string Key => "ModuleAvailabilityTrueLoadFilesChain.Settings";

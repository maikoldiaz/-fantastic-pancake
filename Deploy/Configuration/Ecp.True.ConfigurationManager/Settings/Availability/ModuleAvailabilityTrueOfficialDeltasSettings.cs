// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModuleAvailabilityTrueOfficialDeltasSettings.cs" company="Microsoft">
...
namespace Ecp.True.ConfigurationManager.Settings
{
    ...
    /// </summary>
    public class ModuleAvailabilityTrueOfficialDeltasSettings : SettingsBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModuleAvailabilityTrueOfficialDeltasSettings"/> class.
        /// </summary>
        public ModuleAvailabilityTrueOfficialDeltasSettings()
        {
            this.Name = "TrueOfficialDeltas";
        ...
        /// </value>
        [JsonIgnore]
        public override string Key => "ModuleAvailabilityTrueOfficialDeltas.Settings";

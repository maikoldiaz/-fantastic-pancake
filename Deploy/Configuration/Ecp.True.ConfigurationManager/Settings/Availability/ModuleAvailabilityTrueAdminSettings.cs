// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModuleAvailabilityTrueAdminSettings.cs" company="Microsoft">
...
namespace Ecp.True.ConfigurationManager.Settings
{
    ...
    /// </summary>
    public class ModuleAvailabilityTrueAdminSettings : SettingsBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModuleAvailabilityTrueAdminSettings"/> class.
        /// </summary>
        public ModuleAvailabilityTrueAdminSettings()
        {
            this.Name = "TrueAdmin";
        ...
        /// </value>
        [JsonIgnore]
        public override string Key => "ModuleAvailabilityTrueAdmin.Settings";

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModuleAvailabilityTrueOwnershipSettings.cs" company="Microsoft">
...
namespace Ecp.True.ConfigurationManager.Settings
{
    ...
    /// </summary>
    public class ModuleAvailabilityTrueOwnershipSettings : SettingsBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModuleAvailabilityTrueOwnershipSettings"/> class.
        /// </summary>
        public ModuleAvailabilityTrueOwnershipSettings()
        {
            this.Name = "TrueOwnership";
        ...
        /// </value>
        [JsonIgnore]
        public override string Key => "ModuleAvailabilityTrueOwnership.Settings";

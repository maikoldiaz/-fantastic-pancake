// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModuleAvailabilityTrueOperativeDeltasSettings.cs" company="Microsoft">
...
namespace Ecp.True.ConfigurationManager.Settings
{
    ...
    /// </summary>
    public class ModuleAvailabilityTrueOperativeDeltasSettings : SettingsBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModuleAvailabilityTrueOperativeDeltasSettings"/> class.
        /// </summary>
        public ModuleAvailabilityTrueOperativeDeltasSettings()
        {
            this.Name = "TrueOperativeDeltas";
        ...
        /// </value>
        [JsonIgnore]
        public override string Key => "ModuleAvailabilityTrueOperativeDeltas.Settings";

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OptionalIfAttributeAdapter.cs" company="Microsoft">
...
namespace Ecp.True.Host.Core.Adapter
{
    ...
    public class OptionalIfAttributeAdapter : AttributeAdapterBase<OptionalIfAttribute>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptionalIfAttributeAdapter"/> class.
        /// </summary>
        ...
        public OptionalIfAttributeAdapter(OptionalIfAttribute attribute, IStringLocalizer stringLocalizer)

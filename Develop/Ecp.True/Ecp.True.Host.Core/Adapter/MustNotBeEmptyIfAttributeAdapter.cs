// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MustNotBeEmptyIfAttributeAdapter.cs" company="Microsoft">
...
namespace Ecp.True.Host.Core.Adapter
{
    ...
    public class MustNotBeEmptyIfAttributeAdapter : AttributeAdapterBase<MustNotBeEmptyIfAttribute>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MustNotBeEmptyIfAttributeAdapter"/> class.
        /// </summary>
        ...
        public MustNotBeEmptyIfAttributeAdapter(MustNotBeEmptyIfAttribute attribute, IStringLocalizer stringLocalizer)

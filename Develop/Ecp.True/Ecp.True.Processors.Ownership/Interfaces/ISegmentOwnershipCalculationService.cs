// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ISegmentOwnershipCalculationService.cs" company="Microsoft">
...
namespace Ecp.True.Processors.Ownership.Interfaces
{
    ...
    /// </summary>
    public interface ISegmentOwnershipCalculationService
    {
        /// <summary>
        ...
        Task<IEnumerable<SegmentOwnershipCalculation>> ProcessSegmentOwnershipAsync(

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BlockchainEventV2.cs" company="Microsoft">
...
namespace Ecp.True.Processors.Blockchain.Entities
{
    ...
    public class BlockchainEventV2 : IBlockchainEventV2
    {
        /// <summary>
        ...
        /// The identifier.
        /// </value>
        public string Identifier => $"0x{BitConverter.ToString(this.Id).Replace("-", string.Empty, StringComparison.OrdinalIgnoreCase)}";
    }
}

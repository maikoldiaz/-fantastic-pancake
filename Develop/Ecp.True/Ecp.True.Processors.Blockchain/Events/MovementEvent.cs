// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MovementEvent.cs" company="Microsoft">
...
namespace Ecp.True.Processors.Blockchain.Events
{
    ...
    public class MovementEvent : TransactionEvent
    {
        /// <summary>
        ...
        /// </value>
        [Parameter("int64", "OperationalDate", 3, true)]
        [JsonIgnore]
        ...
        /// The ownership.
        /// </value>
        public string OperationalDate => this.Date.ToTrueDateString();

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DeltaOriginalInventory.cs" company="Microsoft">
...
namespace Ecp.True.Proxies.OwnershipRules.Request
{
    ...
    /// <summary>
    /// The DeltaOriginalInventory.
    /// </summary>
    /// <seealso cref="Ecp.True.Entities.Query.QueryEntity" />
    [DisplayName("inventarioOriginales")]
    public class DeltaOriginalInventory
    {
        /// <summary>

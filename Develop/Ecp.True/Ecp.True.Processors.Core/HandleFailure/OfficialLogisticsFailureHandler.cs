// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OfficialLogisticsFailureHandler.cs" company="Microsoft">
...
namespace Ecp.True.Processors.Core.HandleFailure
{
    ...
    /// <summary>
    /// Official Logistics FailureHandler.
    /// </summary>
    public class OfficialLogisticsFailureHandler : FailureHandlerBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OfficialLogisticsFailureHandler"/> class.
        /// </summary>
        /// <param name="logger">The logger.</param>
        public OfficialLogisticsFailureHandler(
             ITrueLogger<OfficialLogisticsFailureHandler> logger)
             : base(logger)
        {
        }
        ...
        /// </summary>
        /// <inheritdoc />
        public override TicketType TicketType => TicketType.OfficialLogistics;

...
-- Description:     This Procedure is to Get TimeOne Movement Owner Details Data for system Category, Element, Node, StartDate, EndDate.
-- EXEC [Admin].[usp_SaveOperationalMovementOwnerWithoutCutOffForSystem] 'Sistema','Transporte Test','GALAN','2020-04-17','2020-04-17','49CA1512-8ACD-4105-9271-01648C1155CC'
--  EXEC [Admin].[usp_SaveOperationalMovementOwnerWithoutCutOffForSegment] 'Sistema','Automation_8srjq','Todos','2020-06-01','2020-06-10','9e67b8af-3d22-400f-bdb5-85a41a7a245a'
   SELECT * FROM [Admin].[OperationalMovementOwner] WHERE InputCategory = 'Sistema' AND ExecutionId = '49CA1512-8ACD-4105-9271-01648C1155CC' 
-- ==============================================================================================================================*/
CREATE PROCEDURE [Admin].[usp_SaveOperationalMovementOwnerWithoutCutOffForSystem]
(
        @CategoryId                 INT 
       ,@ElementId                  INT 
       ,@NodeId                     INT 
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'This Procedure is to Get TimeOne Movement Owner Details Data for system Category, Element, Node, StartDate, EndDate.',
    @level0type = N'SCHEMA',
    @level0name = N'Admin',
    @level1type = N'PROCEDURE',
    @level1name = N'usp_SaveOperationalMovementOwnerWithoutCutOffForSystem',
    @level2type = NULL,
    @level2name = NULL

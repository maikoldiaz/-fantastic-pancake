...
--Updated date : Jun-15-2020 -- Added BatchId column as per PBI 31874
--<Description>:  This table holds the data for movements before cutoff. This table is being used in before cutoff report.</Description>
=================================================================================================================================*/
CREATE TABLE Admin.OperationalMovement
(
	--Columns
     OperationalMovementId                  INT                                 NOT NULL IDENTITY(1,1),
	 RNo									INT									NOT NULL,
	...
	--Constraints
    CONSTRAINT [PK_OperationalMovementId]               PRIMARY KEY CLUSTERED ([OperationalMovementId] ASC),
    CONSTRAINT [FK_OperationalMovement_ReportExecution]	FOREIGN KEY ([ExecutionId])			REFERENCES [Admin].[ReportExecution] ([ExecutionId])
)
GO

ALTER TABLE [Admin].[OperationalMovement] SET (LOCK_ESCALATION = DISABLE)
GO
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'Admin',
    @level1type = N'TABLE',
    @level1name = N'OperationalMovement',
    @level2type = N'COLUMN',
    @level2name = N'RNo'
GO
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'The movement identifier by the process',
    @level0type = N'SCHEMA',
    @level0name = N'Admin',
    @level1type = N'TABLE',
    @level1name = N'OperationalMovement',

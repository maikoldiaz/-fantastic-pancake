...
--<Description>: This table holds the data Movement Related to Report Of System.</Description>
=================================================================================================================================*/
CREATE TABLE [Admin].[MovementInformationMovforSystemReport]
(
     [MovementInformationMovforSystemReportId]    INT               NOT NULL IDENTITY(1,1),
	...
	--Constraints
    CONSTRAINT [PK_MovementInformationMovforSystemReportId]	        PRIMARY KEY CLUSTERED (MovementInformationMovforSystemReportId ASC),
    CONSTRAINT [FK_MovementInformationMovforSystemReport_ReportExecution]	FOREIGN KEY ([ExecutionId])			REFERENCES [Admin].[ReportExecution] ([ExecutionId])
)
Go

ALTER TABLE [Admin].[MovementInformationMovforSystemReport]   SET (LOCK_ESCALATION = DISABLE)
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'This table holds the data Movement Related to Report Of System.',
    @level0type = N'SCHEMA',
    @level0name = N'Admin',
    @level1type = N'TABLE',
    @level1name = N'MovementInformationMovforSystemReport',
    @level2type = NULL,
    @level2name = NULL
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level1name = N'MovementInformationMovforSystemReport',
    @level2type = N'COLUMN',
    @level2name = N'MovementInformationMovforSystemReportId'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',

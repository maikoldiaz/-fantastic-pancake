...
-- Description:     This Table is to Get TimeOne Inventory Owner Quality Monthly Details Data for Segment Category, Element, Node, StartDate, EndDate.
-- ==============================================================================================================================*/
CREATE TABLE [Admin].[OfficialMonthlyInventoryQualityDetails]
(
	--Columns
	[RNo]							INT						NOT NULL,
    [System]                        NVARCHAR (150)          NOT NULL,
    ...
    --Constraints
    CONSTRAINT [FK_OfficialMonthlyInventoryQualityDetails_ReportExecution]	FOREIGN KEY ([ExecutionId])			REFERENCES [Admin].[ReportExecution] ([ExecutionId]),
    
     --Indexes
    [OfficialMonthlyInventoryQualityDetailsId] INT IDENTITY (1,1) CONSTRAINT PK_Official_Monthly_Inventory_Quality_Details_Id PRIMARY KEY CLUSTERED
)
GO

ALTER TABLE [Admin].[OfficialMonthlyInventoryQualityDetails]  SET (LOCK_ESCALATION = DISABLE)
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'Admin',
    @level1type = N'TABLE',
    @level1name = N'OfficialMonthlyInventoryQualityDetails',
    @level2type = N'COLUMN',
    @level2name = N'RNo'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level1name = N'OfficialMonthlyInventoryQualityDetails',
    @level2type = N'COLUMN',
    @level2name = N'OfficialMonthlyInventoryQualityDetailsId'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',

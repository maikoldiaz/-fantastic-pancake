...
-- Description:     This Table is to Get TimeOne movement Owner Details Monthly Data for Segment Category, Element, Node, StartDate, EndDate.
-- ==============================================================================================================================*/
CREATE TABLE [Admin].[OfficialMonthlyMovementDetails]
(
  --Columns
  [RNo]                    INT                    NOT NULL,
  ...
  [CreatedDate]            DATETIME               NOT NULL, 
    ...
    --Constraints
    CONSTRAINT [FK_OfficialMonthlyMovementDetails_ReportExecution]	FOREIGN KEY ([ExecutionId])			REFERENCES [Admin].[ReportExecution] ([ExecutionId]),

  --Indexes
  [OfficialMonthlyMovementDetailsId] INT IDENTITY (1,1) CONSTRAINT PK_Official_Monthly_Movement_Details_Id PRIMARY KEY CLUSTERED
)
GO

ALTER TABLE [Admin].[OfficialMonthlyMovementDetails] SET (LOCK_ESCALATION = DISABLE)
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'Admin',
    @level1type = N'TABLE',
    @level1name = N'OfficialMonthlyMovementDetails',
    @level2type = N'COLUMN',
    @level2name = N'RNo'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level1name = N'OfficialMonthlyMovementDetails',
    @level2type = N'COLUMN',
    @level2name = N'OfficialMonthlyMovementDetailsId'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',

...
================================================================================================================================*/
CREATE TABLE [Admin].[KPIPreviousDateDataByCategoryElementNodeWithOwner] 
  (
     FilterType                    VARCHAR (50),
	 OrderToDisplay                INT,
	 CategoryPrev                  NVARCHAR (150),
	 ElementPrev                   NVARCHAR (150),
	 NodeNamePrev                  NVARCHAR (150),
	 NodeId                        INT,
	 CalculationDatePrev           DATE,
	 Product                       NVARCHAR (150),
	 Indicator                     NVARCHAR (50),
	 CurrentValuePrev              DECIMAL (18,2),
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'Admin',
    @level1type = N'TABLE',
    @level1name = N'KPIPreviousDateDataByCategoryElementNodeWithOwner',
    @level2type = N'COLUMN',
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level1name = N'KPIPreviousDateDataByCategoryElementNodeWithOwner',
    @level2type = N'COLUMN',
    @level2name = N'CalculationDatePrev'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level1name = N'KPIPreviousDateDataByCategoryElementNodeWithOwner',
    @level2type = N'COLUMN',
    @level2name = N'CurrentValuePrev'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Ownership TicketId of the record',
    @level0type = N'SCHEMA',
    @level0name = N'Admin',
    @level1type = N'TABLE',
    @level1name = N'KPIPreviousDateDataByCategoryElementNodeWithOwner',

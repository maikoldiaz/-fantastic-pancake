...
--<Description>: This table holds the KPI data by category element node with owner values. 
  SELECT * FROM [Admin].[KPIPreviousDateDataByCategoryElementNode]
================================================================================================================================*/
CREATE TABLE [Admin].[KPIPreviousDateDataByCategoryElementNode] 
  (
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'Admin',
    @level1type = N'TABLE',
    @level1name = N'KPIPreviousDateDataByCategoryElementNode',
    @level2type = N'COLUMN',

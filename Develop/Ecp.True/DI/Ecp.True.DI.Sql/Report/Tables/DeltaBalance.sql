...
--Updated date : Aug-25-2020  Changed the data type from INT to NVARCHAR for ProductId column
...
=================================================================================================================================*/
CREATE TABLE [Report].[DeltaBalance] 
    (
      [DeltaBalanceId]                      INT              IDENTITY (1,1) NOT NULL,
	...
	--Constraints
    CONSTRAINT [PK_DeltaBalanceId]	PRIMARY KEY CLUSTERED ([DeltaBalanceId] ASC)
    )
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level0name = N'Report',
    @level1type = N'TABLE',
    @level1name = N'DeltaBalance',
    @level2type = N'COLUMN',
    @level2name = N'DeltaBalanceId'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Element id column',
    @level0type = N'SCHEMA',
    @level0name = N'Report',
    @level1type = N'TABLE',
    @level1name = N'DeltaBalance',

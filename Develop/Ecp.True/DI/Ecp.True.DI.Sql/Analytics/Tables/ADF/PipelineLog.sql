...
-- Updated Date:	Mar-20-2020
 <Description>:		This table holds the data for the Pipeline Log.  </Description>

-- ================================================================================================================================*/
CREATE TABLE [Analytics].[PipelineLog]
(
	...
	--Constraints
	CONSTRAINT [PK_Analytics_PipelineId]						PRIMARY KEY CLUSTERED ([PipelineId] ASC),
	CONSTRAINT [FK_Analytics_PipelineLog_AuditStatus]			FOREIGN KEY([PipelineStatusId]) REFERENCES [Analytics].AuditStatus (StatusId)
)

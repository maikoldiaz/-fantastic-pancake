...
-- ================================================================================================================================*/
CREATE TABLE [Analytics].[OperativeNodeRelationship] 
( 
     --Columns 

	[OperativeNodeRelationshipId]				INT IDENTITY (1, 1)				NOT NULL, 
	...
	--Constraints
	CONSTRAINT [PK_OperativeNodeRelationship]	PRIMARY KEY CLUSTERED ([OperativeNodeRelationshipId] ASC),
	
	--Indexes
	INDEX NIX_OperativeNodeRelationship_SourceNode NONCLUSTERED (SourceNode),
	INDEX NIX_OperativeNodeRelationship_DestinationNode NONCLUSTERED (DestinationNode),
	INDEX NIX_OperativeNodeRelationship_SourceNodeType NONCLUSTERED (SourceNodeType),
	INDEX NIX_OperativeNodeRelationship_DestinationNodeType NONCLUSTERED (DestinationNodeType),
	INDEX NIX_OperativeNodeRelationship_SourceProduct NONCLUSTERED (SourceProduct),
	INDEX NIX_OperativeNodeRelationship_SourceProductType NONCLUSTERED (SourceProductType),
	INDEX NIX_OperativeNodeRelationship_MovementType NONCLUSTERED (MovementType)
);


GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'The identifier of the node relationship without ownership',
    @level0type = N'SCHEMA',
    @level0name = N'Analytics',
    @level1type = N'TABLE',
    @level1name = N'OperativeNodeRelationship',
    @level2type = N'COLUMN',
    @level2name = N'OperativeNodeRelationshipId'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',

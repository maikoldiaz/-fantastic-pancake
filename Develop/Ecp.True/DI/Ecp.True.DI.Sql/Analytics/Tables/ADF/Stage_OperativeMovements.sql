...
-- Updated Date:	Mar-20-2020
 <Description>:		This table holds the data for the Operative Movements from CSV.  </Description>

-- ================================================================================================================================*/
CREATE TABLE [Analytics].[Stage_OperativeMovements] 
( 
	--Columns 
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    ...
    @level1type = N'TABLE',
    @level1name = N'Stage_OperativeMovements',
    @level2type = N'COLUMN',
...
GO
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'This table holds the data for the Operative Movements from CSV.',
    @level0type = N'SCHEMA',
    @level0name = N'Analytics',
    @level1type = N'TABLE',
    @level1name = N'Stage_OperativeMovements',

...
-- ================================================================================================================================*/
CREATE TABLE [Analytics].[OperativeNodeRelationshipWithOwnership] 
( 
     --Columns 

	[OperativeNodeRelationshipWithOwnershipId]				INT IDENTITY (1, 1)			NOT NULL, 
	...
	--Constraints
	CONSTRAINT [PK_OperativeNodeRelationshipWithOwnership]	PRIMARY KEY CLUSTERED ([OperativeNodeRelationshipWithOwnershipId] ASC)
)
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'The identifier of the node relationship with ownership',
    @level0type = N'SCHEMA',
    @level0name = N'Analytics',
    @level1type = N'TABLE',
    @level1name = N'OperativeNodeRelationshipWithOwnership',
    @level2type = N'COLUMN',
    @level2name = N'OperativeNodeRelationshipWithOwnershipId'
GO
EXEC sp_addextendedproperty @name = N'MS_Description',

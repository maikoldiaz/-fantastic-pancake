...
/***/ function (module, exports, __webpack_require__) {
		...
		var Widget = (function () {
			...
			Widget.prototype.onGetAccessTokenCallbackAdded = function () {
				...
				if ((string_1.stringIncludes(this.sdkOption.hostName, SdkSettings_1.SdkSettings.govHostName, 0))) {
					authResource = SdkSettings_1.SdkSettings.govAuthResource;
				}
				else if ((string_1.stringIncludes(this.sdkOption.hostName, SdkSettings_1.SdkSettings.highHostName, 0))) {
			...
			Widget.prototype.renderIframe = function () {
				...
				this.listen('GET_WIDGET_OPTIONS', function (_requestParam, doneCallback) {
					doneCallback(null, {
						flowsFilter: _this.widgetOption.flowsSettings && _this.widgetOption.flowsSettings.flowsFilter,
						waitAfterInstallingFlow: _this.widgetOption.runtimeSettings && _this.widgetOption.runtimeSettings.waitAfterInstallingFlow,
					});
				});
			};
...
/***/ function (module, exports, __webpack_require__) {
		...
		function getEnvironmentUrl(hostName, environmentName) {
			...
			if (hostName && (string_1.stringIncludes(hostName, SdkSettings_1.SdkSettings.govHostName, 0))) {
				flowApiUrl = SdkSettings_1.SdkSettings.govApiUrl;
			}
			else if (hostName && (string_1.stringIncludes(hostName, SdkSettings_1.SdkSettings.highHostName, 0))) {

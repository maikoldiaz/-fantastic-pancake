...
class OwnersPie extends React.Component {
    ...
    buildData() {
        return this.props.nodeProduct.owners.map(o => {
            return {
                name: o.owner.name,
    ...
    render() {
        ...
        return (
            <>
                <section className="ep-modal__content ep-modal__content--scroll" id="cont_nodeProducts_ownership_pie">
                ...
                <ModalFooter config={footerConfigService.getCommonConfig('nodeProducts_ownershippie',
...
const mapStateToProps = state => {
    return {
        nodeProduct: state.node.attributes.nodeProduct
    };
};

...
const officialNodeStatusReportFilterBuilder = (function () {
    const filters = [];
    ...
    return {
        build: function (values) {
            ...
            buildExecutionIdFilter('NodeOficialStatus', values.executionId);
            return filters;
        }
    };
}());

export { officialNodeStatusReportFilterBuilder };

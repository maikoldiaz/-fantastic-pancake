    ...
    public static class OpenApiSettings
    {
        ...
        public static void AddOpenApiConfiguration(AspNetCoreOpenApiDocumentGeneratorSettings config)
        {
            ...
            config.PostProcess = document =>
            {
                ...
                document.Info.Title = "TRUE Admin API";
                document.Info.Description = "TRUE System Administration API";
            ...
            config.OperationProcessors.Add(new ExistsOperationProcessor());
            config.OperationProcessors.Add(new GetByIdOperationProcessor());

...
namespace Ecp.True.DataAccess.Sql
{
    ...
    /// </summary>
    /// <seealso cref="Ecp.True.DataAccess.Sql.Configuration.EntityConfiguration{Ecp.True.Entities.Role}" />
    public class RoleConfiguration : EntityConfiguration<Role>
    {
        ...
        public RoleConfiguration()
                : base(x => x.RoleId, Sql.Constants.AdminSchema, true)
        {
        }
        ...
        protected override void DoConfigure(EntityTypeBuilder<Role> builder)
        {
            ArgumentValidators.ThrowIfNull(builder, nameof(builder));

            builder.Ignore(x => x.LastModifiedBy);
            builder.Ignore(x => x.LastModifiedDate);
            builder.Property(x => x.RoleName).IsRequired().HasMaxLength(260);
        }
    }
}

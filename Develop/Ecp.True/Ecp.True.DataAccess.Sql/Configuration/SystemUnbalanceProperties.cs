// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SystemUnbalanceProperties.cs" company="Microsoft">
...
namespace Ecp.True.DataAccess.Sql.Configuration
{
    ...
    /// <summary>
    /// the system unbalance properties.
    /// </summary>
    public static class SystemUnbalanceProperties
    {
        /// <summary>
        /// Configures the properties for system unbalance.
        /// </summary>

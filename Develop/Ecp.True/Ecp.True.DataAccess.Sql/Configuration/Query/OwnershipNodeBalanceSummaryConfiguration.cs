// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OwnershipNodeBalanceSummaryConfiguration.cs" company="Microsoft">
...
namespace Ecp.True.DataAccess.Sql.Configuration.Query
{
    ...
    /// </summary>
    /// <seealso cref="Ecp.True.DataAccess.Sql.Configuration.Query.QueryEntityConfiguration{Ecp.True.Entities.Admin.OwnershipNodeBalanceSummary}" />
    public class OwnershipNodeBalanceSummaryConfiguration : QueryEntityConfiguration<OwnershipNodeBalanceSummary>
    {
        /// <summary>
        /// Does the configure.
        /// </summary>
        /// <param name="builder">The builder.</param>
        protected override void DoConfigure(QueryTypeBuilder<OwnershipNodeBalanceSummary> builder)
        {
            ...
            builder.Property(x => x.Control).HasColumnType("decimal");
        }
    }
}

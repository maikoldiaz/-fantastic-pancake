// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MovementCalculationInputConfiguration.cs" company="Microsoft">
...
namespace Ecp.True.DataAccess.Sql.Configuration.Query
{
    ...
    /// </summary>
    /// <seealso cref="Ecp.True.DataAccess.Sql.Configuration.Query.QueryEntityConfiguration{Ecp.True.Entities.Query.MovementCalculationInput}" />
    public class MovementCalculationInputConfiguration : QueryEntityConfiguration<MovementCalculationInput>
    {
        /// <summary>
        /// Does the configure.
        /// </summary>
        /// <param name="builder">The builder.</param>
        protected override void DoConfigure(QueryTypeBuilder<MovementCalculationInput> builder)
        {

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OwnershipCalculationProperties.cs" company="Microsoft">
...
namespace Ecp.True.DataAccess.Sql.Configuration
{
    ...
    /// <summary>
    /// the ownership calculation properties.
    /// </summary>
    public static class OwnershipCalculationProperties
    {
        /// <summary>
        /// Configures the properties for ownership calculations.
        /// </summary>

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SegmentCalculator.cs" company="Microsoft">
...
namespace Ecp.True.Processors.Balance.Calculation
{
    ...
    /// Segment Calculator.
    /// </summary>
    public class SegmentCalculator : SystemSegmentCalculatorBase, ISegmentCalculator
    {
        /// <summary>
        ...
        /// The task.
        /// </returns>
        public SegmentUnbalance CalculateAndGetSegmentUnbalance(
              string productId,
              DateTime date,
              int ticketId,
              int segmentId,
              ...
              IUnitOfWork unitOfWork)
        {
            ...
            var segmentUnbalanceCalculation = new SegmentUnbalance
            {
                Date = date.Date,
                ProductId = productId,
                TicketId = ticketId,
            ...
            return segmentUnbalanceCalculation;
        }
    }
}

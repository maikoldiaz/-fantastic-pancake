// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IMovementValidator.cs" company="Microsoft">
...
namespace Ecp.True.Processors.Registration.Interfaces
{
    ...
    public interface IMovementValidator
    {
        ...
        /// </returns>
        Task<(bool isValid, Movement movement)> ValidateMovementAsync(FileRegistrationTransaction fileRegistrationTransaction, JToken homologatedJson);
    }
}
...
namespace Ecp.True.Entities.Query
{
    ...
    /// The contract.
    /// </summary>
    public class Contract : QueryEntity
    {
        /// <summary>
        ...
        public string ResponseContractUnit
        {
            get
            {
                return (this.ContractUnit == "%" || (this.ContractUnit != null
                    && this.ContractUnit.ToUpper(System.Globalization.CultureInfo.InvariantCulture) == "PORCENTAJE")) ? "PORCENTAJE" : "VOLUMEN";
            }
        }

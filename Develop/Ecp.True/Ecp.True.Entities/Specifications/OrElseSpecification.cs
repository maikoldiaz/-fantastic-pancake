// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OrElseSpecification.cs" company="Microsoft">
...
namespace Ecp.True.Entities.Specifications
{
    ...
    public class OrElseSpecification<TEntity> : LogicSpecification<TEntity>
        where TEntity : IEntity
    {
        ...
        public OrElseSpecification(ISpecification<TEntity> left, ISpecification<TEntity> right)
            : base(left, right)
        {
        }
        ...
        public override Expression<Func<TEntity, bool>> ToExpression() =>
            this.Left.ToExpression().OrElse(this.Right.ToExpression());
